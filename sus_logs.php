        ...
        <div class="card2">
            <div class="table-container2">
                <table class="table" border="1">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM suspicious_logins ORDER BY date DESC, time DESC";
                        ...
                        if ($result) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $input_value = htmlspecialchars($row['input_value'], ENT_QUOTES, 'UTF-8');
                            ...
                            <td>
                                <img src="data:image/jpeg;base64,' . $imageData . '" alt="Suspicious Activity Image" style="width: 100px; height: auto;">
                            </td>
                            <td>' . $input_value . '</td>
                            <td>
                                <button class="view-image-btn" data-image="data:image/jpeg;base64,' . $imageData . '">View</button>
                            </td>
                          </tr>';
                            }
                        }
